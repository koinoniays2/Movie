                                ...
                                {people.map((item, index) => (
                                    <article key={index} className="w-full flex justify-center mb-10">
                                        <div className="flex flex-col items-center mb-4">
                                            ...
                                            <p className="font-bold text-center text-ml"><b>배우</b> : {item.name}</p>
                                            <p className="text-[0.8rem] text-gray-500 overflow-hidden whitespace-nowrap overflow-ellipsis">
                                                <b>역할</b> : {item.character}</p>
                                        </div>
                                    </article>
                                ))}
                            </Slider>
